...
import { FirebaseService, FirebaseAppInternals, _FirebaseApp, _FirebaseNamespace, FirebaseServiceFactory, AppHook, FirebaseServiceNamespace } from "@firebase/app-types/private";
